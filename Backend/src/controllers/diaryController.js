  ...
  try {
    ...
    await db.query(
      ...
      [
        ...
        content !== undefined ? content : existing[0][0].content,
        category_id !== undefined ? category_id : existing[0][0].category_id,
        category_name !== undefined ? category_name : existing[0][0].category_name,
        mood !== undefined ? mood : existing[0][0].mood,
        JSON.stringify(Array.isArray(tags) ? tags : parseJsonField(tags !== undefined ? tags : existing[0][0].tags)),
        location !== undefined ? location : existing[0][0].location,
        entry_date !== undefined ? entry_date : existing[0][0].entry_date,
        entry_time !== undefined ? entry_time : existing[0][0].entry_time,
