...
const { register, login, getAllUsers, googleLogin, getProfile, updateProfile, changePassword, updateUser, updateUserStatus, deleteUser } = require("../controllers/authController");
